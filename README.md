...
# Перевод не применяется к именам уже полученных вещей, только к тем которые будут получены после замены файла Translation.json
перевод текстов заданий и описаний обновляется при входе в игру.
