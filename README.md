...
# Изменения
После входа в игру вернул часть описаний маг эффектов, лазать каждый раз через меню чтобы посмотреть что дает чарка не удобно
исправил синтаксичесую ошибку, кто успел скачать извиняйте теперь все работает
